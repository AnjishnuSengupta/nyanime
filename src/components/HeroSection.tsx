  ...
  return (
    <section className="relative w-full h-[50vh] sm:h-[60vh] md:h-[70vh] lg:h-[80vh] overflow-hidden">
      ...
      <div className="relative z-10 h-full flex flex-col justify-end">
        <div className="container mx-auto px-4 md:px-6 pb-10 sm:pb-14 md:pb-16 lg:pb-20">
          <div className="max-w-3xl">
            {slides.map((slide, index) => (
              ...
              >
                ...
                <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-2 sm:mb-3 leading-tight">{slide.title}</h1>
                <p className="text-white/80 text-xs sm:text-sm md:text-base mb-4 sm:mb-6 max-w-2xl line-clamp-2 sm:line-clamp-3">
